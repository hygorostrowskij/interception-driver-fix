...
// constexpr auto MY_INSTALL_UNINSTALL_MUTEX_STABLE_KEY_NAME   = L"SOFTWARE";
// constexpr auto MY_INSTALL_UNINSTALL_MUTEX_VOLATILE_KEY_NAME = L"Witsy.tmp\\InstallUninstallMutex";
